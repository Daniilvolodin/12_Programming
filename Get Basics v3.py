# Functions that offers user a list of options
def text_helper(question,possible_answers,items_per_line,required=None):
    ...
    while not valid:
        ...
        # Check that reponse has been given if required
        ...
        try:
            ...
            # User typed in text, return it to the main routine
            return  response
...
# Sorting List
genre_list = ["Action","Adventure","Detective","Crime","Fan-Fiction","Anthology"]
