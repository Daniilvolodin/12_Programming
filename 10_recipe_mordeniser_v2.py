...
for recipe_line in full_recipe:
    ...
    if num_spaces > 1:
        ...
        if amount[1] == "yes":
            ...
            if amount_2[1] == "yes":
                modernised_recipe.append(
                    "{:.0f} g {}".format(amount_2[0], ingredient))  # Rather than printing, update modernised list (g)
        ...
        # If the unit is not mls, leave the line unchanged
            ...
            modernised_recipe.append(
                "{:.2f} {} {}".format(amount[0], unit, ingredient))  # Update list with scaled amount and original unit
